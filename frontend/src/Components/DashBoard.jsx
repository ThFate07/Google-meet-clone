...
function DashBoard() {
  ...
  // depending on auth value render different things
  return (
    <>
      {authValue ? (
        <div className="background">
          <div className="flex-container gap">
            <div>
              <button className="dash-btn" onClick={createMeeting}>
                Create meeting
              </button>
            </div>
            <h1>OR</h1>
            <div>
              ...
              ></input>
              {error}
              <button className="dash-btn" onClick={joinMeeting}>
                Join meeting
              </button>
            </div>
          </div>
...
export function ErrorComponent() { 
  return (
    <div>
      <p>
        Unauthorized access. Please head to <Link to={"/login"}>Login</Link>{" "}
